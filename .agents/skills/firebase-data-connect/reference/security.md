...
> **Important:** Levels like `USER` are starting points. Always add filters or expressions to verify the user can access
> specific data.
...
During development, set operations to `NO_ACCESS` until you implement proper authorization. Use emulator and VS Code
